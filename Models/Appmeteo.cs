...
namespace Application_meteo_csharp
{
    ...
    {   
        ...
        {  //mettre sa route 
            System.Media.SoundPlayer player = new System.Media.SoundPlayer("C:\\Users\\marce\\OneDrive\\Bureau\\BUREAU\\Ynov\\B2\\Météo CSharp\\Appli-meteo-CSharp\\sound\\BRUIT - CLIC.wav");  
            player.Play();     
            int count = 0;
            string message;
